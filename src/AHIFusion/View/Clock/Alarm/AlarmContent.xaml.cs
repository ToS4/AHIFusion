...
public partial class AlarmContent : Page
{
    public AlarmContent()
    {
        try
        {
            Log.Information("Initializing AlarmContent");
    ...
    private void InitializeControls()
    {
        try
        {
            Log.Information("Initializing controls");
    ...
    private void Alarms_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        try
        {
            Log.Information("Alarms_CollectionChanged has been called");
    ...
    private void AddAlarmControl(Alarm alarm)
    {
        try
        {
            Log.Information("AddAlarmControl has been called");
