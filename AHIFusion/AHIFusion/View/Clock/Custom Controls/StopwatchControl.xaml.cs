...
public sealed partial class StopwatchControl : UserControl
{
    ...
    public StopwatchControl()
    {
        try
        {
            Log.Information("Initializing StopwatchControl");
    ...
    private void LapList_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        try
        {
            Log.Information("LapList_CollectionChanged has been called");
    ...
    private void DispatcherTimer_Tick(object? sender, object e)
    {
        try
        {
            Log.Information("DispatcherTimer_Tick has been called");
    ...
    private void StartStopButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            Log.Information("StartStopButton_Click has been called");
    ...
    private void ResetButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            Log.Information("ResetButton_Click has been called");
    ...
    private void FlagButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            Log.Information("FlagButton_Click has been called");
